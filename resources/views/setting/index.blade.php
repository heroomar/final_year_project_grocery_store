                                ...
                                <div class="setting-card">
                                    ...
                                    <div class="choose-files mt-5">
                                        <label for="company_logo">
                                            ...
                                            <input type="file" accept=".png" id="company_logo" data-filename="company_logo_update"
                                ...
                                <div class=" setting-card">
                                    ...
                                    <div class="choose-files mt-5">
                                        <label for="company_logo_light">
                                            ...
                                            <input type="file" accept=".png" class="form-control file" name="logo_light"
                                ...
                                <div class=" setting-card">
                                    ...
                                    <div class="choose-files mt-5">
                                        <label for="company_favicon">
                                            ...
                                            <input type="file" accept=".png" class="form-control file" id="company_favicon"
...
<script>
    var rtl={};
    rtl.checked=false;
    function check_theme(name){
        $('[value='+name+']').prop('checked',true)
        $('[data-value='+name+']').addClass('active_color').siblings().removeClass('active_color')
    }
</script>
@endpush